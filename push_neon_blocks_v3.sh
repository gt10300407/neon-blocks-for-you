...
git add index.html README.md push_neon_blocks_v3.sh

if git diff --cached --quiet; then
  echo "변경된 파일이 없어. 기존 버전을 그대로 사용한다."
else
  git commit -m "feat: add low-heat controls combos and neon overdrive"
fi
...
echo "=============================================="
echo "배포 완료"
echo "게임: https://${OWNER}.github.io/${REPO}/?v=3"
