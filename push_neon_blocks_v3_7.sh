...
BRANCH="main"
SCRIPT_NAME="push_neon_blocks_v3_7.sh"
...
if ! git -C "$WORK_DIR" diff --cached --quiet; then
  git -C "$WORK_DIR" commit -m "fix: extend auto fever duration and pause timer"
fi
...
echo
echo "========================================"
echo "유진공주 테트리스 v3.7 배포 완료"
echo "게임: https://$OWNER.github.io/$REPO/?v=3.7"
