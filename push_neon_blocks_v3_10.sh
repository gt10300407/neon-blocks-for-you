...
BRANCH="main"
SCRIPT_NAME="push_neon_blocks_v3_10.sh"
...
if ! git -C "$WORK_DIR" diff --cached --quiet; then
  git -C "$WORK_DIR" commit -m "fix: restore swipe labels without iOS text loupe"
fi
...
echo
echo "========================================"
echo "유진공주 테트리스 v3.10 배포 완료"
echo "게임: https://$OWNER.github.io/$REPO/?v=3.10"
